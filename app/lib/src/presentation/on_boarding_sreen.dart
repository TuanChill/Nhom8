...
List<OnBoarding> onBoardinglist = [
  OnBoarding(
    ...
    description:
        'Truy cập các công cụ và tài nguyên học tiếng Anh cần thiết để giúp bạn chinh phục ngôn ngữ này một cách dễ dàng.',
  ),
  OnBoarding(
      title: 'Trải nghiệm tương tác và thú vị',
      image: ImagesPath.kOnboarding2,
      description:
          'Tham gia các bài kiểm tra, kể chuyện và luyện hội thoại được thiết kế để giữ động lực và làm cho việc học trở nên thú vị.'),
  OnBoarding(
      title: "Mở khóa tính năng cao cấp",
      image: ImagesPath.kOnboarding3,
      description:
          'Tiếp cận nội dung nâng cao và công cụ học tập cá nhân hóa để có trải nghiệm học tiếng Anh sâu sắc và toàn diện hơn.'),
];
